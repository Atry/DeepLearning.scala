...
trait Tensors extends OpenCL with FloatArrayTrees with StructuralTrees {
//
...
//
  protected trait TensorUpvalueApi extends TermApi { this: TensorUpvalue =>
    val tensor: Tensor
//
...
//        new StructuralKey(closure),
//        new Callable[CompiledKernel] {
//          def call(): CompiledKernel = {
//
//            val AlphaConversion(oldParameters, renamedParameters, convertedTerm) =
//              closure.alphaConversion(Nil, Nil)
//            val sourceCode = OpenCLValues.generateOpenCLKernelSourceCode(raw"""${closure.id}_kernel""",
//                                                                         shape.length,
//                                                                         renamedParameters,
//                                                                         Seq(convertedTerm))
